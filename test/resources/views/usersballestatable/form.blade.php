...
@endif	
			{!! Form::open(array('url'=>'usersballestatable/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'usersballestatableFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> usersballestaTable</legend>
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("usersballestatable/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
	...
	var form = $('#usersballestatableFormAjax'); 
	form.parsley();
